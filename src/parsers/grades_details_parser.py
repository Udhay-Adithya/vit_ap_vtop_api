...
<body class="overflow-auto" style="padding-top: 61px;">
    ...
    <div class="container-fluid">
        ...
        <script>
            ...
            var csrfName = "_csrf";
            var csrfValue = "2f40cd10-05fb-455b-9b5e-2350c06d8aa6";
            var id ="23BCE7625";
            var now = new Date();
                        ...
                        <li class="nav-item dropdown d-none d-sm-inline-block">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end headerBackgroundColor dropdownMenuBoxWidth" aria-labelledby="navbarDropdown">
                                ...
                                <li class="dropdown-item bg-transparent">
                                    <form class="text-center" id="logoutForm1" name="logoutForm1" method="post" action="/vtop/logout"><input type="hidden" name="_csrf" value="2f40cd10-05fb-455b-9b5e-2350c06d8aa6">
                                        <input type="hidden" name="_csrf" value="2f40cd10-05fb-455b-9b5e-2350c06d8aa6">
        ...
        <div class="btn-toolbar mx-1" role="toolbar" aria-label="Toolbar with button groups">
            <div class="btn-group-vertical" role="group" aria-label="First group">
                    ...
                    <a data-url="summerInternship/summerInternshipReviewMarksStdPage" class="dropdown-item menuFontStyle systemBtnMenu " href="javascript:void(0);">&nbsp;&nbsp;&nbsp;<i class="fa fa-dot-circle-o iconSpace "></i> Summer Internship Review Marks</a>
                    ...
                    </div></div><div class="btn-group dropend"><button type="button" class="btn btn-outline-primary p-1 border-0 text-dark SideBarMenuBtn" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"><i class="fa fa-book iconSpace"></i></button><div class="dropdown-menu border-0 py-0 shadow-lg dropdownMenuBoxWidth text-nowrap SideBarMenuDropDown" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(38px, 250px, 0px);" data-popper-placement="right-start"><div class="fw-bold h6 py-3 text-center menuHeaderColor menuHeaderFontStyle"> Examination </div>
                    ...
                    </div></div><div class="btn-group dropend"><button type="button" class="btn btn-outline-primary p-1 border-0 text-dark SideBarMenuBtn" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false"><i class="fa fa-dot-circle-o iconSpace"></i></button><div class="dropdown-menu border-0 py-0 shadow-lg dropdownMenuBoxWidth text-nowrap SideBarMenuDropDown"><div class="fw-bold h6 py-3 text-center menuHeaderColor menuHeaderFontStyle"> Feedback </div>
        ...
        <script>
            ...
            function assembleData() {
                ...
                let csrfName = "_csrf";
                let csrfValue = "2f40cd10-05fb-455b-9b5e-2350c06d8aa6";
	...
	<div id="main-section">
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">Student Grade History</h3>
					</div>
								...
								<div>
									<div>
										...
										<div class="col-md-12">
											<div align="center" id="fixedTableContainer" class="fixedTableContainer">
												<table class="customTable" style="align: center;">
													<tbody><tr class="tableHeader">
														...
														<!-- <span
															style="float: right;"
															th:if="${student.getStudySystem()}=='CAL' or  ${student.getStudySystem()}=='CBCS' or  ${student.getStudySystem()}=='FFCS'"> <a
																class="btn btn-primary btn-success"
																th:href="@{'javascript:vtopDownload(\''+'examinations/examGradeView/doDownloadStudentHistory'+'\')'}"><span
																	class="glyphicon glyphicon-download-alt">&nbsp;Download
																		History</span></a>
														</span> 
														
														<span style="float: right;"
															th:if="${student.getStudySystem()}!='CAL' and ${student.getStudySystem()}!='CBCS' and ${student.getStudySystem()}!='FFCS'"> <a
																class="btn btn-primary btn-success"
																th:href="@{'javascript:vtopDownload(\''+'examinations/examGradeView/doDownloadStudentHistoryNonCAL'+'\')'}"><span
																	class="glyphicon glyphicon-download-alt">&nbsp;Download
																		History</span></a>
														</span> -->
													...
													<tr class="tableHeader">
														...
														<td style="width: 34%;">Course Title</td>
														<td style="width: 5%;">Course Type</td>
														<td style="width: 5%;">Credits</td>
														<td style="width: 5%;">Grade</td>
														<td style="width: 8%;">Exam Month</td>
														<td style="width: 10%;">Result Declared</td>
														<td style="width: 10%;">Course Distribution</td>
														<td style="width: 5%;">Detail View</td>
													</tr>
													
														<tr class="tableContent">
															<td style="width: 5%;" class="textAlign-center">1</td>
															<td style="width: 8%;" class="textAlign-center">CSE1012</td>
															<td style="width: 34%;">Problem Solving using Python</td>
															<td style="width: 5%;" class="textAlign-center">ETL</td>
															<td style="width: 5%;" class="textAlign-center">4.0</td>
															<td style="width: 5%;" class="textAlign-center">A</td>
															<td style="width: 8%;" class="textAlign-center">Jan-2024</td>
															<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
															<td style="width: 10%;" class="textAlign-center">UE</td>
															<td style="width: 5%;" class="textAlign-center">
																<!--  <a th:href="'javascript:toggleDiv(\''+ ${stdHistory.courseCatalogCode} + '\');'"
																 style="background-color: #ccc; padding: 5px 10px;">Show / Hide</a> -->
																<button type="button" name="action" onclick="javascript:toggleDiv('CSE1012');" class="icon-button">
																...
																<div align="center">
																	<table class="customTable-level1" style="align: center; width: 90%">
																		<tbody><tr class="tableHeader-level1">
																			...
																			<td style="width: 10%;">Exam Month</td>
																			<td style="width: 10%;">Result Declared</td>
																		</tr>
																		
																			<tr class="tableContent-level1">
																				<td style="width: 10%;" class="textAlign-center">CSE1012</td>
																				<td style="width: 10%;">Problem Solving using Python</td>
																				<td style="width: 10%;" class="textAlign-center">ETL</td>
																				<td style="width: 10%;" class="textAlign-center">4.0</td>
																				<td style="width: 10%;" class="textAlign-center">A</td>
																				<td style="width: 10%;" class="textAlign-center">Jan-2024</td>
																				<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
																			</tr>
																			...
																			<tr class="tableContent-level1">
																				<td style="width: 10%;" class="textAlign-center">CSE1012</td>
																				<td style="width: 10%;">Problem Solving using Python</td>
																				<td style="width: 10%;" class="textAlign-center">ETH</td>
																				<td style="width: 10%;" class="textAlign-center"></td>
																				<td style="width: 10%;" class="textAlign-center">-</td>
																				<td style="width: 10%;" class="textAlign-center">Jan-2024</td>
																				<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
																			</tr>
																			...
																			<tr class="tableContent-level1">
																				<td style="width: 10%;" class="textAlign-center">CSE1012</td>
																				<td style="width: 10%;">Problem Solving using Python</td>
																				<td style="width: 10%;" class="textAlign-center">ELA</td>
																				<td style="width: 10%;" class="textAlign-center"></td>
																				<td style="width: 10%;" class="textAlign-center">-</td>
																				<td style="width: 10%;" class="textAlign-center">Jan-2024</td>
																				<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
														...
														<tr class="tableContent">
															<td style="width: 5%;" class="textAlign-center">2</td>
															<td style="width: 8%;" class="textAlign-center">ECE1002</td>
															<td style="width: 34%;">Fundamentals of Electrical and Electronics Engineering</td>
															<td style="width: 5%;" class="textAlign-center">ETL</td>
															<td style="width: 5%;" class="textAlign-center">4.0</td>
															<td style="width: 5%;" class="textAlign-center">B</td>
															<td style="width: 8%;" class="textAlign-center">Jan-2024</td>
															<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
															<td style="width: 10%;" class="textAlign-center">UE</td>
															<td style="width: 5%;" class="textAlign-center">
																<!--  <a th:href="'javascript:toggleDiv(\''+ ${stdHistory.courseCatalogCode} + '\');'"
																 style="background-color: #ccc; padding: 5px 10px;">Show / Hide</a> -->
																<button type="button" name="action" onclick="javascript:toggleDiv('ECE1002');" class="icon-button">
																	<span class="glyphicon glyphicon-menu-down glyphiconDefault"></span>
																</button>
															</td>
														</tr>
														...
														<tr class="tableContent" style="display: none;" id="detailsView_ECE1002">
															<td colspan="11" align="center">
																<div align="center">
																	<table class="customTable-level1" style="align: center; width: 90%">
																		<tbody><tr class="tableHeader-level1">
																			...
																			<tr class="tableContent-level1">
																				<td style="width: 10%;" class="textAlign-center">ECE1002</td>
																				<td style="width: 10%;">Fundamentals of Electrical and Electronics Engineering</td>
																				<td style="width: 10%;" class="textAlign-center">ETL</td>
																				<td style="width: 10%;" class="textAlign-center">4.0</td>
																				<td style="width: 10%;" class="textAlign-center">B</td>
																				<td style="width: 10%;" class="textAlign-center">Jan-2024</td>
																				<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
																			</tr>
														...
														<tr class="tableContent">
															<td style="width: 5%;" class="textAlign-center">3</td>
															<td style="width: 8%;" class="textAlign-center">ENG1002</td>
															<td style="width: 34%;">English for Effective Communication</td>
															<td style="width: 5%;" class="textAlign-center">ETL</td>
															<td style="width: 5%;" class="textAlign-center">3.0</td>
															<td style="width: 5%;" class="textAlign-center">B</td>
															<td style="width: 8%;" class="textAlign-center">Jan-2024</td>
															<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
															<td style="width: 10%;" class="textAlign-center">UE</td>
															<td style="width: 5%;" class="textAlign-center">
																<!--  <a th:href="'javascript:toggleDiv(\''+ ${stdHistory.courseCatalogCode} + '\');'"
																 style="background-color: #ccc; padding: 5px 10px;">Show / Hide</a> -->
																<button type="button" name="action" onclick="javascript:toggleDiv('ENG1002');" class="icon-button">
																	<span class="glyphicon glyphicon-menu-down glyphiconDefault"></span>
																</button>
															</td>
														</tr>
														...
														<tr class="tableContent" style="display: none;" id="detailsView_ENG1002">
															<td colspan="11" align="center">
																<div align="center">
																	<table class="customTable-level1" style="align: center; width: 90%">
																		<tbody><tr class="tableHeader-level1">
																			...
																			<tr class="tableContent-level1">
																				<td style="width: 10%;" class="textAlign-center">ENG1002</td>
																				<td style="width: 10%;">English for Effective Communication</td>
																				<td style="width: 10%;" class="textAlign-center">ETL</td>
																				<td style="width: 10%;" class="textAlign-center">3.0</td>
																				<td style="width: 10%;" class="textAlign-center">B</td>
																				<td style="width: 10%;" class="textAlign-center">Jan-2024</td>
																				<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
																			</tr>
														...
														<tr class="tableContent">
															<td style="width: 5%;" class="textAlign-center">4</td>
															<td style="width: 8%;" class="textAlign-center">MAT1001</td>
															<td style="width: 34%;">Calculus for Engineers</td>
															<td style="width: 5%;" class="textAlign-center">ETL</td>
															<td style="width: 5%;" class="textAlign-center">4.0</td>
															<td style="width: 5%;" class="textAlign-center">F</td>
															<td style="width: 8%;" class="textAlign-center">Jan-2024</td>
															<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
															<td style="width: 10%;" class="textAlign-center">UE</td>
															<td style="width: 5%;" class="textAlign-center">
																<!--  <a th:href="'javascript:toggleDiv(\''+ ${stdHistory.courseCatalogCode} + '\');'"
																 style="background-color: #ccc; padding: 5px 10px;">Show / Hide</a> -->
																<button type="button" name="action" onclick="javascript:toggleDiv('MAT1001');" class="icon-button">
																	<span class="glyphicon glyphicon-menu-down glyphiconDefault"></span>
																</button>
															</td>
														</tr>
														...
														<tr class="tableContent" style="display: none;" id="detailsView_MAT1001">
															<td colspan="11" align="center">
																<div align="center">
																	<table class="customTable-level1" style="align: center; width: 90%">
																		<tbody><tr class="tableHeader-level1">
																			...
																			<tr class="tableContent-level1">
																				<td style="width: 10%;" class="textAlign-center">MAT1001</td>
																				<td style="width: 10%;">Calculus for Engineers</td>
																				<td style="width: 10%;" class="textAlign-center">ETL</td>
																				<td style="width: 10%;" class="textAlign-center">4.0</td>
																				<td style="width: 10%;" class="textAlign-center">F</td>
																				<td style="width: 10%;" class="textAlign-center">Jan-2024</td>
																				<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
																			</tr>
														...
														<tr class="tableContent">
															<td style="width: 5%;" class="textAlign-center">5</td>
															<td style="width: 8%;" class="textAlign-center">PHY1008</td>
															<td style="width: 34%;">Modern Physics</td>
															<td style="width: 5%;" class="textAlign-center">ETL</td>
															<td style="width: 5%;" class="textAlign-center">4.0</td>
															<td style="width: 5%;" class="textAlign-center">B</td>
															<td style="width: 8%;" class="textAlign-center">Jan-2024</td>
															...
															<td style="width: 5%;" class="textAlign-center">
																<!--  <a th:href="'javascript:toggleDiv(\''+ ${stdHistory.courseCatalogCode} + '\');'"
																 style="background-color: #ccc; padding: 5px 10px;">Show / Hide</a> -->
																<button type="button" name="action" onclick="javascript:toggleDiv('PHY1008');" class="icon-button">
																	<span class="glyphicon glyphicon-menu-down glyphiconDefault"></span>
																</button>
															</td>
														</tr>
														...
														<tr class="tableContent" style="display: none;" id="detailsView_PHY1008">
															<td colspan="11" align="center">
																<div align="center">
																	<table class="customTable-level1" style="align: center; width: 90%">
																		<tbody><tr class="tableHeader-level1">
																			...
																			<tr class="tableContent-level1">
																				<td style="width: 10%;" class="textAlign-center">PHY1008</td>
																				<td style="width: 10%;">Modern Physics</td>
																				<td style="width: 10%;" class="textAlign-center">ETL</td>
																				<td style="width: 10%;" class="textAlign-center">4.0</td>
																				<td style="width: 10%;" class="textAlign-center">B</td>
																				<td style="width: 10%;" class="textAlign-center">Jan-2024</td>
														...
														<tr class="tableContent">
															<td style="width: 5%;" class="textAlign-center">6</td>
															<td style="width: 8%;" class="textAlign-center">STS1004</td>
															<td style="width: 34%;">Introduction to Problem Solving</td>
															<td style="width: 5%;" class="textAlign-center">TH</td>
															<td style="width: 5%;" class="textAlign-center">3.0</td>
															<td style="width: 5%;" class="textAlign-center">A</td>
															<td style="width: 8%;" class="textAlign-center">Jan-2024</td>
															<td style="width: 10%;" class="textAlign-center">29-Mar-2024</td>
											...
											<br>
											<!-- <div id="legend" style="color: red;">
												<ul>
													<li><span
														style="font-weight: bold; text-decoration: underline;">N1
													</span>: Student fails to clear one or more components of a course</li>
													<li><span
														style="font-weight: bold; text-decoration: underline;">N2
													</span>: Student who has been debarred due to lack of attendance</li>
													<li><span
														style="font-weight: bold; text-decoration: underline;">N3
													</span>: Student who has been absent in the Final Assessment Test</li>
													<li><span
														style="font-weight: bold; text-decoration: underline;">N4
													</span>: Student debarred in Final Assessment Test due to
														indiscipline/malpractice</li>
												</ul>
											</div> -->
											...
											<!-- <div th:if="${curriculamDetailsDto}" align="center"
												id="fixedTableContainer" class="fixedTableContainer">
												<table class="customTable" style="align: center;">
													<tr class="tableHeader">
														<td colspan="3">Curriculum Details</td>
													</tr>
													<tr class="tableHeader">
														<td>Curriculum Distribution Type</td>
														<td>Credits Required</td>
														<td>Credits Earned</td>
													</tr>
													<tr class="tableContent"
														th:each="cCategory,itr:${curriculamDetailsDto.creditDetais}">
														<td>
														<span  th:text="${cCategory.value.creditTypeDesc}"></span>
														<span th:if="${#dates.format(student.getStudyStartDate(), 'yyyy')}>=2019"
														style="color: red;">
														<span th:if="${cCategory.key=='BC'} or ${cCategory.key=='FCNG'}">
														( Not mandatory and not affect the CGPA)
														</span>
														<span th:if="${cCategory.key=='NC' or cCategory.key=='NGCR'}">
														( Mandatory and not affect the CGPA)
														</span>
														</span>
														...
														<td th:text="${cCategory.value.creditsActual}"></td>
														<td th:text="${cCategory.value.creditsEarned}"
															th:style="${cCategory.value.creditsEarnedStyle}"></td>
													</tr>
													<tr class="fixedContent tableContent">
														<td th:text="'Total Credits'"></td>
														<td th:text="${curriculamDetailsDto.totalCreditsActual}"></td>
														<td th:text="${curriculamDetailsDto.totalCreditsEarned}"
															th:style="${curriculamDetailsDto.totalCreditsEarnedStyle}"></td>
													</tr>
												</table>
											</div> -->
											<!-- <br />

											<div th:if="${basketDetails}" align="center"
												id="fixedTableContainer" class="fixedTableContainer">
												<table class="customTable" style="align: center;">
													<tr class="tableHeader">
														<td colspan="4">Basket Details</td>
													</tr>
													<tr class="tableHeader">
														<td>Basket Title</td>
													...
													<tr th:each="bCourse, ite : ${basketDetails}"
														class="tableContent">
														<td th:text="${bCourse.basketDesc}"></td>
														<td th:text="${bCourse.basketCurriculumType}"></td>
														<td th:text="${bCourse.requiredCredits}"></td>
														<td th:text="${bCourse.earnedCredits}"
															th:style="${bCourse.earnedCreditsStyle}"></td>
													</tr>
												</table>
											</div> -->
											...
											<div>
										<div class=" col-md-12">
											<div class="box  col-md-12" style="border-bottom: 1px solid orange; border-left: 1px solid orange; border-right: 1px solid orange;border-top: 3px solid orange;">
												<div class="box-header ">
													<h3 class="box-title" style="font-weight: bold;">CGPA
														Details</h3>
												</div>
												<div class="box-body table-responsive ">
													<table class="table table-hover table-bordered" style="border-bottom-color: #b1dfff; border-left-color: #b1dfff; border-right-color: #b1dfff;">
														<thead style="background-color: #626D71">
															<tr style="color: #fff; font-weight: bold; white-space: nowrap;background-color:orange; ">
									...
									<br>
											<br>
											<!-- <div th:if="${graduatedInfo}">
												<div class="col-md-12">
													<div class="box box-primary col-md-11"
														style="border-bottom: 1px solid #3c8dbc; border-left: 1px solid #3c8dbc; border-right: 1px solid #3c8dbc;">
														<div class="box-header ">
															<h3 class="box-title"
																style="color: green; font-weight: bold;">The
																Candidate is ELIGIBLE for the award of the DEGREE.</h3>
														</div>
														<div align="center" id="fixedTableContainer"
															class="fixedTableContainer">
															<table class="customTable" style="align: center;">
																<tr class="tableHeader">
																	<td><span> Programme And Branch</span></td>
																	<td><span>Exam Month</span></td>
																	<td><span> Total Credit Registered</span></td>
																	<td><span> Total Credit Earned</span></td>
																	<td><span> CGPA</span></td>

																</tr>
																<tr th:each="graduate,gIdx : ${graduatedInfo}"
																	class="tableContent">
																	<td><span th:text="${graduate.pgmSpecDesc}"></span>
																	</td>
																	<td
																		th:text="${graduate.getId().getExamMonth()!=null} ? ${#dates.format(graduate.getId().getExamMonth(), 'MMM-yyyy')} : '-' ">
																	</td>
																	<td><span
																		th:text="${graduate.totalCreditRegistered}"></span></td>

																	<td><span th:text="${graduate.totalCreditEarned}"></span></td>
																	<td><span
																		th:text="${graduate.cumulativeGradePointAverage}"></span>
																	</td>
																</tr>
															</table>
														</div>
												...
												<div class="col-md-12">
													<div class="box box-primary col-md-11"
														...
														<div align="center" id="fixedTableContainer"
															...
															<table class="customTable" style="align: center;">
																<tr class="tableHeader">
																	<td><span>Oral date</span></td>
																	<td><span> Title</span></td>
																</tr>

																<tr class="tableContent">
																	<td
																		th:text="${grdRech.getId().getOralDate()!=null} ? ${#dates.format(grdRech.getId().getOralDate(), 'dd-MMM-yyyy')} : '-' ">
																	</td>
																	<td
																		th:utext="${grdRech.getTitle()!=null ? grdRech.getTitle() : '-'}"></td>
																</tr>
															</table>
														</div>
											...
											<!-- <div th:if="${dto!=null}">
												<div class="col-md-12">
													<div class="box  col-md-12"
														style="border-bottom: 1px solid #d2d6de; border-left: 1px solid #d2d6de; border-right: 1px solid #d2d6de;">
														<div class="box-header ">
															<h3 class="box-title" style="font-weight: bold;">
																Graduate Additional Information</h3>
														</div>
														<div class="box-body table-responsive ">
															<table class="table table-hover table-bordered"
																style="border-bottom-color: #b1dfff; border-left-color: #b1dfff; border-right-color: #b1dfff;">
																<thead style="background-color: #626D71">
																	<tr
																...
																<tbody>
																	...
																	<tr style="background-color: #e6e6e6;">
																		<td th:text="${dto.getDescrption()}"></td>
																		<td th:text="${dto.getTotalCreditReg()}"></td>
																		<td th:text="${dto.getTotalCreditEarn()}"></td>
																		<td th:text="${dto.getCgpa()}"></td>
		...
		<script>
			...
			jQuery(document).ready(function() {
				...
				jQuery("#studentGradeView").validationEngine('attach', {
					autoHidePrompt : true,
					binded : false,
			...
			function doViewExamGrade() {
				var myform = document.getElementById("studentGradeView");
			...
			function getGradeViewDetails() {
				...
				var params = "authorizedID=" + authorizedID + "&x="
						+ now.toUTCString() + "&regNo=" + regNo+"&"+csrfName+"="+csrfValue;
				$
						.blockUI({
							message : '<img src="assets/img/482.GIF"> loading... Just a moment...'
						});
				$.ajax({
					url : "examinations/examGradeView/getGradeViewDetails",
					type : "POST",
					data : params,
					success : function(response) {
						$.unblockUI();
			...
			function toggleDiv(divId) {
				var toggleId = "detailsView_" + divId;
				var displaySts = $("#" + toggleId).css("display");
				if (displaySts == 'none') {
					var a = $("[id*='detailsView_']");
					var i;
					...
					$("#" + toggleId).attr('style', "display: contents;");
				} else {
					$("#" + toggleId).attr('style', "display: none;");
				}
			...
			/*]]>*/
                ...
                <a data-url="summerInternship/summerInternshipReviewMarksStdPage" class="dropdown-item menuFontStyle textColor2 systemMainMenu " href="javascript:void(0);">&nbsp;&nbsp;&nbsp;<i class="fa fa-dot-circle-o iconSpace "></i> Summer Internship Review Marks</a>
...
<div id="624F6735-178B-851F-188B-DF498E5AB8B8"></div></body></html>"""
